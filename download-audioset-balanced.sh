...
# ==============================================================================
# AudioSet Balanced Train Segments Downloader
# ==============================================================================

# Configuration
CSV_FILE="balanced_train_segments.csv"
OUTPUT_DIR="/itet-stor/feigao/net_scratch/datasets/audioset/balanced_train_segments"
TEMP_DIR="./audioset_temp_balanced"
